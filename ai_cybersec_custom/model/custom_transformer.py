...
class CustomTransformer(nn.Module):
    ...
    - Features: RoPE, Flash Attention, RMSNorm (pre-norm), SparseMoE, gradient checkpointing.
    ...
    def __init__(self, vocab_size: int, hidden_size: int = 512, num_layers: int = 6, 
                 num_heads: int = 8, ff_expansion: int = 4, num_experts: int = 4):
        super().__init__()
...
# Example usage:
# model = CustomTransformer(vocab_size=50258)
